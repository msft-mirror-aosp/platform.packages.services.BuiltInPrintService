...
#define PRINTER_IDLE_BIT       (1U << 31)
#define PRINTER_IS_IDLE(X)     ((X) << PRINT_STATUS_MAX_STATE)
#define PRINTER_STATUS_MASK(X) ((X) & (PRINTER_IDLE_BIT - 1))

#define BLOCKED_REASON_UNABLE_TO_CONNECT (LONG_ONE << PRINT_STATUS_UNABLE_TO_CONNECT)
#define BLOCKED_REASONS_PRINTER_BUSY     (LONG_ONE << PRINT_STATUS_BUSY)
#define BLOCKED_REASONS_CANCELLED        (LONG_ONE << PRINT_STATUS_CANCELLED)
#define BLOCKED_REASON_OUT_OF_PAPER      (LONG_ONE << PRINT_STATUS_OUT_OF_PAPER)
#define BLOCKED_REASON_OUT_OF_INK        (LONG_ONE << PRINT_STATUS_OUT_OF_INK)
#define BLOCKED_REASON_OUT_OF_TONER      (LONG_ONE << PRINT_STATUS_OUT_OF_TONER)
#define BLOCKED_REASON_JAMMED            (LONG_ONE << PRINT_STATUS_JAMMED)
#define BLOCKED_REASON_DOOR_OPEN         (LONG_ONE << PRINT_STATUS_DOOR_OPEN)
#define BLOCKED_REASON_SVC_REQUEST       (LONG_ONE << PRINT_STATUS_SVC_REQUEST)
#define BLOCKED_REASON_LOW_ON_INK        (LONG_ONE << PRINT_STATUS_LOW_ON_INK)
#define BLOCKED_REASON_LOW_ON_TONER      (LONG_ONE << PRINT_STATUS_LOW_ON_TONER)
#define BLOCKED_REASON_UNKNOWN           (LONG_ONE << PRINT_STATUS_UNKNOWN)
#define BLOCKED_REASON_BUSY              (LONG_ONE << PRINT_STATUS_PRINTING)
#define BLOCKED_REASON_IDLE              (LONG_ONE << PRINT_STATUS_IDLE)
#define BLOCKED_REASON_CANCELLED         (LONG_ONE << PRINT_STATUS_CANCELLED)
#define BLOCKED_REASON_PRINT_STATUS_VERY_LOW_ON_INK (LONG_ONE << PRINT_STATUS_VERY_LOW_ON_INK)
#define BLOCKED_REASON_PARTIAL_CANCEL    (LONG_ONE << PRINT_STATUS_PARTIAL_CANCEL)
